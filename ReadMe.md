...
This hook is used in place of the Route component to access all of the match features available.

2. How would you explain form validation to someone who has never programmed before?

Think of everytime you sign up on a website, or sign in, and it will give you an error if your password is incorrect, or if your email isn't valid, that is what is called form validation. A programmer will tell the computer what is required for a form to be submitted, and it will show you the approriate error.

3. In 1-2 sentences, define end to end testing.

These are tests that will simulate a user using all of the UI features on your site from top to bottom.
